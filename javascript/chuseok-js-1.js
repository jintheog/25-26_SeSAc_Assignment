...
XXX : 함수명: 함수의 이름. 함수를 호출 할떄 사용
YYY : 매개변수: parameter 함수가 전달 받을 값
ZZZ : 반환값: 함수 실행후 최종적으로 돌려주는 값. 
*/
...
/**
 * 배열의 생성 방법: 대괄호로 생성. let arr = []; 배열의 원소는 , 로 구분
 * 배열 원소 추가 방법: arr[1] = 10;
 * arr.push(10); 배열 맨 끝에 추가
 * arr.unshift(1); 배열 맨 앞에 추가
 *
 */
// 문제 [실습]
 ...
 * filter()는 원본 배열에서 조건에 맞는 원소를 골라네서 true / false 를 반환 하고 true인 원소들을 새 배열에 추가. 원본 배열과 길이가 다를 수도 있다
 */
// 문제 [실습]
